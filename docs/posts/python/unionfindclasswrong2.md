...
<iframe :src="withBase('/code-pages/python/unionfindclasswrong2.html')" width="100%" height="1600px" style="border:1px solid #3c3c3c;border-radius:8px" title="UnionFindClassWrong2.py - Monaco Editor"></iframe>
